#ifndef BASE_HTTP_PARSER_WRAPPER_H
#define BASE_HTTP_PARSER_WRAPPER_H
...
private:
    ...
    bool m_read_all{ false };
    bool m_read_referer{ false };
    bool m_read_forward_ip{ false };
    bool m_read_user_agent{ false };
    bool m_read_content_type{ false };
    bool m_read_content_len{ false };
    bool m_read_host{ false };

    uint32_t    m_total_length{ 0 };
    std::string	m_url{ "" };
    std::string	m_body_content{ "" };
    std::string	m_referer{ "" };
    std::string m_forward_ip{ "" };
    std::string m_user_agent{ "" };
    std::string m_content_type{ "" };
    uint32_t  m_content_len{ 0 };
    std::string m_host{ "" };
};

#endif  // BASE_HTTP_PARSER_WRAPPER_H
